...
export function CoffeeForm({ setCoffees }: CoffeeFormProps) {
    ...
    return <div>
        <button
            className={coffeeSize === COFFEE_SIZES.SMALL ? 'button-active' : undefined}
            onClick={() => handleClick(COFFEE_SIZES.SMALL)}
        >
            {COFFEE_SIZES.SMALL}
        </button>
        <button
            className={coffeeSize === COFFEE_SIZES.MEDIUM ? 'button-active' : undefined}
            onClick={() => handleClick(COFFEE_SIZES.MEDIUM)}
        >
            {COFFEE_SIZES.MEDIUM}
        </button>
        <button
            className={coffeeSize === COFFEE_SIZES.LARGE ? 'button-active' : undefined}
